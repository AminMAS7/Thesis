function [Output_Main_FP] = Main_Direct_FP_Rnd_Assoc(A_init_Decoupled,B,S,N,Ther_Noise_mat,SystemParams,h,h_bar,h_tilde,BL_mat,OptParams,BiSecParam)
...
for t = 2 : T_main_FP
    ...
    [Output_PowerAll_FP] = Power_All_FP(A,B,S,N,Ther_Noise_mat,SystemParams,h,h_bar,h_tilde,OptParams,BiSecParam);
