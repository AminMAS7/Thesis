...
function [SumRate_HO_MBN,Rate_HO_MBN,SumRate_HO_THz,SumRate_HO_RF,SumRate_MBN,Rate_MBN,Infeas_flg,Tmax,THz_SINR,RF_SINR,alpha_n,beta_n,W_mat,U_mat] = ...
    MBN_Opt_Stat_Func(T_Inp,T_MaxMin,General_Struct,Traj_data,eps_conv,Pmax_THz,H_mat,H_tilde_mat,B_T,K,M,Rth_vec,THz_BW,Clus_Siz_THz,UA_flg,...
...
for t = 2 : T
    ...
    if UA_flg == 1
        ...
        maximize sum( 1*log(F_QoS_THz) + 1*log(F_QoS_RF) )
    end
