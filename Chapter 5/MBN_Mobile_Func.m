...
for n = 1 : N
    ...
    [PL_THz_GT,PL_tilde_THz_GT,~,H_GT,H_tilde_GT,~] = THz_Channel(0.5,v,K,B_T,M,THz_User_Dist_GT,AoD_THz_Users_Angle_GT,Traj_data,General_Struct,1);
    ...
    [PL_RF_GT,~,G_GT,~] = RF_Channel(0.5,v,K,B_R,M_hat,RF_User_Dist_GT,AoD_RF_Users_Angle_GT,RF_Rayleigh_mat_GT,Traj_data,General_Struct,1);
...
function [Eff_H_mat,Eff_H_tilde_mat,Eff_Arr_Resp_THz] = Eff_Channel_THz_V4(F_Analog,H_mat,PL_THz,PL_tilde_THz,B_T,K,M,General_Struct,Traj_data,MaxMin_flg)
...
if MaxMin_flg == 0
    ...
    F_Analog_per = repmat( permute(F_Analog,[1,3,2]), [1,1,1,N_GT]);
...
function [Eff_G_mat,Eff_Ch_Resp_RF] = Eff_Channel_RF_V4(Q_Analog,G_mat,PL_RF,B_R,M_hat,K,General_Struct,Traj_data,MaxMin_flg)
...
if MaxMin_flg == 0
    ...
    Channel_phasor_per = permute(Channel_phasor,[1,3,2,4]);
    Q_Analog_per = repmat(permute(Q_Analog,[1,3,2]), [1,1,1,N_GT]);
